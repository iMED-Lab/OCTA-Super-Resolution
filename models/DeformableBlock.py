...
from models.Dynamic_offset_estimator import Dynamic_offset_estimator, Dynamic_offset_estimator_concat

# from mmcv.ops.deform_conv import DeformConv2d
from DCNv2.dcn_v2 import DCNv2
from models.utils import saveoffset, showpatch
...
class DeformableConvBlock(nn.Module):
    def __init__(self, input_channels, mode):
        ...
        self.deformconv = DCNv2(in_channels=input_channels, out_channels=input_channels, kernel_size=3,stride=1,
                                       padding=1)
...
class DeformableConvBlock_show(nn.Module):
    def __init__(self, input_channels, mode):
        ...
        self.deformconv = DCNv2(in_channels=input_channels, out_channels=input_channels, kernel_size=3,
