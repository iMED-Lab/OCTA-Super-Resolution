...
def make_downsampling_network(layernum = 2, in_channels = 1, out_channels = 64):
    layers = []
    ...
    for _ in range(layernum-1):
        layers.append(nn.Conv2d(in_channels=out_channels, out_channels=out_channels, kernel_size=3, stride=1, bias=False,padding=1))
    print(layers)
