...
def add_Gaussian_noise(img, noise_level1=2, noise_level2=25):
    ...
    if rnum < 0.4: # add grayscale Gaussian noise
...
def degradation_bsrgan(img, sf=2, lq_patchsize=72, isp_model=None):
    """
    ...
    for i in range(7):
        ...
        #
            ...
            if random.random() > 0.6:
                img = add_speckle_noise(img, noise_level1=2, noise_level2=25)
        #
        # elif i == 6:
